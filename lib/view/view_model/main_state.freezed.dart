...
abstract class $MainStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({List<SubwayModel> subways, bool isLoading});
}
...
class _$MainStateImpl with DiagnosticableTreeMixin implements _MainState {
  const _$MainStateImpl(
      {final List<SubwayModel> subways = const [], this.isLoading = false})
      : _subways = subways;
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'MainState(subways: $subways, isLoading: $isLoading)';
  }
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties
      ...
      ..add(DiagnosticsProperty('subways', subways))
